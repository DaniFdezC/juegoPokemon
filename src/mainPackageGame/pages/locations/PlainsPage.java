...
public class PlainsPage extends JFrame {

    private JPanel contentPane;

    public PlainsPage(Connection connection, String user) {
        int widthFrame = 1200;
        int heightFrame = 900;
        ...
        imageBackground.setIcon(getImageLocation("plains",true,widthFrame,heightFrame));
