...
import static mainPackageGame.extras.Images.getBasicBackground;
import static mainPackageGame.extras.Images.getImageLocation;

public class VolcanoPage extends JFrame {

    private JPanel contentPane;

    public VolcanoPage(Connection connection, String user) {
        int widthFrame = 1200;
        int heightFrame = 900;
        ...
        imageBackground.setIcon(getImageLocation("volcano",true,widthFrame,heightFrame));
