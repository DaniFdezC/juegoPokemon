...
public class PowerplantPage extends JFrame {

    private JPanel contentPane;

    public PowerplantPage(Connection connection, String user) {
        int widthFrame = 1200;
        int heightFrame = 900;
        ...
        imageBackground.setIcon(getImageLocation("powerplant",false,widthFrame,heightFrame));
